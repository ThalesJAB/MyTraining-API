...
public class DbService {
	...
	public void initBd() {
		...
		Person person1 = new Person(null, "Thales", 22, 90.1, 1.77, null);
		Person person2 = new Person(null, "Maria", 25, 60.2, 1.60, null);
		Person person3 = new Person(null, "Pedro", 40, 90.0, 1.80, null);
		Person person4 = new Person(null, "João", 30, 80.5, 1.75, null);
